...
mod tests {
    ...
    fn dir_path_split_alternates_colors() {
        ...
        let f = facts(None, "~/Projects/cake-muffin", None, 0, None, None, None);
        let out = render(&f, &c).left;
        // Components joined by /, alternating fg 31/39 on bg 236.
        assert!(out.contains(
            "\x1b[38;5;39;48;5;236mProjects\x1b[38;5;244m/\x1b[38;5;31;48;5;236mcake-muffin"
        ));
    }
    ...
    fn dir_truncation() {
        ...
        let t = truncate_dir("~/Projects/cake-muffin/src", 12);
